...
LOCAL_PATH="/home/fruntxas/code/Fruntxas/TaxiFareModel/raw_data/train_1k.csv" # Replace with your local path to the `train_1k.csv` and make sure to put it between quotes
